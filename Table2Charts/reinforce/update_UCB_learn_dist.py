...
from reinforce.student.update_UCB_config import StudentConfig
from reinforce.student.update_UCB_student import Student
...
def parse_args():
    ...
    parser.add_argument('--ucb_exploration', default=0.5, type=float,
                        help='exploration coefficient for UCB over critic scores')
    parser.add_argument('--ucb_eval_exploration', action='store_true',
                        help='keep the UCB exploration bonus enabled during validation/testing')
...
def main(args):
    ...
    student_config = StudentConfig(optimizer, criterion,
                                   ...
                                   ucb_eval_exploration=args.ucb_eval_exploration)
