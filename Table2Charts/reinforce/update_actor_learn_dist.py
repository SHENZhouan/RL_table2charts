...
from update_actor_helper import construct_data_config, create_model, prepare_model
from model import DEFAULT_MODEL_SIZES, DEFAULT_MODEL_NAMES
from os import path, getpid
from reinforce.student.update_actor_config import StudentConfig
from reinforce.student.update_actor_student import UpdateActorStudent
...
def parse_args():
    ...
    parser.add_argument("--actor_loss_weight", default=0.1, type=float,
                        help="Weight for the update_actor policy-gradient style actor loss.")
...
def iteration(epoch: int, student: UpdateActorStudent, is_testing: bool, n_tables: int, args, local_tuids=None):
...
def main(args):
    ...
    student = UpdateActorStudent(student_config, data_config, search_config, ddp, args.apex,
