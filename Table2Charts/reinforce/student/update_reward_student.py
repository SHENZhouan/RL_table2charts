...
from search.agent.update_reward_drill_down import UpdateRewardBeamDrillDownAgent
...
class Student:
    ...
    def add_table(self, tUID: str):
        ...
        self.agents.add(UpdateRewardBeamDrillDownAgent(tUID, self.data_config, self.special_tokens,
                                                       self.search_config))
