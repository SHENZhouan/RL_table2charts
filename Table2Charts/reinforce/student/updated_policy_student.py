...
from search.agent.updated_policy_drill_down import UpdatedPolicyBeamDrillDownAgent
...
class Student:
    ...
    def add_table(self, tUID: str):
        ...
        self.agents.add(UpdatedPolicyBeamDrillDownAgent(tUID, self.data_config, self.special_tokens,
                                                        self.search_config))
