...
from update_actor_helper import save_ddp_checkpoint
...
from .update_actor_config import StudentConfig
...
class UpdateActorStudent:
    ...
    def add_table(self, tUID: str):
        self.agents.add(UpdateActorBeamDrillDownAgent(tUID, self.data_config, self.special_tokens,
                                                       self.search_config))
