...
from reinforce.student.update_MC_light_student import Student
from reinforce.student.update_MC_light_config import StudentConfig
...
def parse_args():
    ...
    parser.add_argument("--negative_weight", default=0.02, type=float)
    ...
    parser.add_argument('--mc_top_k', default=2, type=int,
                        help='lighter root candidate width for MC evaluation')
    parser.add_argument('--mc_rollout_depth', default=1, type=int,
                        help='lightweight rollout depth')
    parser.add_argument('--mc_num_rollouts', default=1, type=int,
                        help='single rollout per root action')
    parser.add_argument('--mc_discount', default=0.9, type=float)
    parser.add_argument('--mc_rollout_weight', default=0.35, type=float,
                        help='smaller rollout contribution for light MC')
    parser.add_argument('--mc_seed', default=20260426, type=int)
    parser.add_argument('--agent_workers', default=0, type=int,
                        help='Number of worker threads for ParallelAgents. 0 chooses an automatic value.')
