...
def swap_field_cmd_scores(input_scores, num_cmd_tokens, source_mask):
    return swap_field_cmd_probs(input_scores.unsqueeze(-1), num_cmd_tokens, source_mask).squeeze(-1)


class UpdateActoreCopyNetSeq2Seq(nn.Module):
...
class UpdateActoreCopyNet(UpdateActoreCopyNetSeq2Seq):
